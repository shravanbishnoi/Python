...
def test_draw_triangle(w,sp):
    ...
    # Allow the user to look at the picture before continuing
    input('Press [return]')
    print("Test draw_Triangle_succesful")
...
def test_draw_spiral(w,sp):
    ...
    # Allow the user to look at the picture before continuing
    input('Press [return]')
    print("Test draw_spiral_succesful")
...
def test_multi_polygons(w,sp):
    ...
    # Allow the user to look at the picture before continuing
    input('Press [return]')
    print('test_multi_polygons_succesful')
...
def test_vicsek(w,sp):
    """
    Tests the procedure vicsek AND vicsek_helper
    ...
    print('Testing vicsek (depth 0)')
    
    # First verify that the preconditions are enforced
    # WE HAVE NOT ADDED ALL OF THEM. YOU MAY NEED TO ADD SOME
    introcs.assert_error(a4.vicsek,'window', 300, 0, sp)
    
    # Now draw (three different depths)
    a4.vicsek(w, 300, 0, sp)
    input('Press [return]')
    
    print('Testing vicsek (depth 1)')
    a4.vicsek(w, 300, 1, sp)
    input('Press [return]')

    print('Testing vicsek (depth 3)')
    a4.vicsek(w, 300, 3, sp)
    input('Press [return]')
    
    print('Testing vicsek_helper')
    # This is only ONE TEST. Feel free to change the values for different tests.
    w.clear()
    pen = Pen(w)
    pen.fillcolor = 'blue'
    ...
    # WE HAVE NOT ADDED ALL OF THEM. YOU MAY NEED TO ADD SOME
    pen.solid = True
    introcs.assert_error(a4.vicsek_helper, pen, 0, 0, 243, 4)
    pen.solid = False
    
    # Now draw
    a4.vicsek_helper(pen, 0, 0, 243, 4)
    pen.flush()
    input('Press [return]')
...
def test_branches(w,sp):
    """
    Tests the procedure branches AND branches_helper
    ...
    """
    # Fractals need a few tests
    print('Testing branches (depth 0)')
    
    # First verify that the preconditions are enforced
    # WE HAVE NOT ADDED ALL OF THEM. YOU MAY NEED TO ADD SOME
    introcs.assert_error(a4.branches, 'window', 300, 90, 0, sp)
    
    # Now draw (three different depths)
    a4.branches(w, 300, 90, 0, sp)
    input('Press [return]')
    
    print('Testing branches (depth 1)')
    a4.branches(w, 300, 90, 1, sp)
    input('Press [return]')

    print('Testing branches (depth 3)')
    a4.branches(w, 300, 90, 3, sp)
    input('Press [return]')
    
    print('Testing branches_helper')
    # This is only ONE TEST. Feel free to change the values for different tests.
    w.clear()
    turt = Turtle(w)
    turt.left(90)
    ...
    # WE HAVE NOT ADDED ALL OF THEM. YOU MAY NEED TO ADD SOME
    turt.drawmode = False
    introcs.assert_error(a4.branches_helper, turt, 200, 45, 4)
    turt.drawmode = True
    ...
    # Now draw
    a4.branches_helper(turt, 400, 60, 6)
    turt.flush()
